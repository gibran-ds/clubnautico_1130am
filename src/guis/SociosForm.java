...
public class SociosForm extends javax.swing.JFrame {
    ...
    private void agregar(){
        ...
        if(seAgregoSocio){
            ...
            JOptionPane.showMessageDialog(this, "No se agregó el socio", 
    ...
    private void actualizar(){
        ...
        boolean seActualizoSocio = this.sociosDAO.actualizar(socioActualizado);
        if(seActualizoSocio){
            ...
            JOptionPane.showMessageDialog(this, "No se actualizó el socio", 
                "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void editar(){
        ...
        if(socio != null){
            ...
            JOptionPane.showMessageDialog(this, "El socio ya no existe", 
                "Información", JOptionPane.WARNING_MESSAGE);
        }
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtIdSocio, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtNombre)
                    .addComponent(txtCurp))
                .addGap(18, 18, 18)
                .addComponent(pnlTablaSocios, javax.swing.GroupLayout.PREFERRED_SIZE, 414, javax.swing.GroupLayout.PREFERRED_SIZE)
